...
public class FlexibleCalendarView extends LinearLayout implements
    ...
    private void init(AttributeSet attrs) {
        ...
        Log.d("VIJAY2","view -- layout "+android.R.layout.simple_list_item_1);
        ...
        System.out.println(" FlexibleCalendarGridAdapter displaymonth "+displayMonth+" "+displayYear+" "+startDayOfTheWeek);
...
*/
    ...
    private class DefaultCalendarView implements CalendarView {
        ...
        public BaseCellView getCellView(int position, View convertView, ViewGroup parent,
                                        int cellType) {
            System.out.println(" FlexibleCalendarGridAdapter cellViewDrawer.getCellView Flexical 1 pos "+position+" convertView "+convertView+" parent "+parent+" cellType "+cellType);
            BaseCellView cellView = (BaseCellView) convertView;
            System.out.println(" FlexibleCalendarGridAdapter cellViewDrawer.getCellView Flexi 2 pos "+cellView);
            if (cellView == null) {
