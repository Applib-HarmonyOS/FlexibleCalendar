...
class FlexibleCalendarGridAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        System.out.println(" FlexibleCalendarGridAdapter day "+day);
        ...
        System.out.println(" FlexibleCalendarGridAdapter cellViewDrawer.getCellView "+cellType);
    ...
    private void drawDateCell(BaseCellView cellView, int day, int cellType) {
        ...
        if (cellType != BaseCellView.OUTSIDE_MONTH) {
            ...
            System.out.println("FlexibleCalendarGridAdapter show "+showDatesOutsideMonth);
